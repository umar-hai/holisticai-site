...
import { buildImageObj, getPaperUrl } from "../../lib/helpers";
import { imageUrlFor } from "../../lib/image-url";
import { format } from "date-fns";

export default function PaperPreviewCard(props) {
  return (
    <Link to={getPaperUrl(props.publishedAt, props.slug.current)}>
